...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-[1320px] gap-12 px-5 pb-28 pt-20 sm:px-8 sm:pb-32 sm:pt-24 lg:grid-cols-12 lg:gap-10 lg:px-12 lg:pb-36 lg:pt-28">
        {/* Index bar */}
        <div
